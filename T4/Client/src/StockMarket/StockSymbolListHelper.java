...
public final class StockSymbolListHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(StockSymbolListHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_alias_tc(StockMarket.StockSymbolListHelper.id(), "StockSymbolList",org.omg.CORBA.ORB.init().create_sequence_tc(0, StockMarket.StockSymbolHelper.type()));
				}
			}
		}
		return _type;
	...
	{
		return "IDL:StockMarket/StockSymbolList:1.0";
	}
